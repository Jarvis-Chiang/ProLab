...
public:
    ...
    void retranslateUi(QWidget *DesignZoneWidget)
    {
        ...
        label_5->setText(QCoreApplication::translate("DesignZoneWidget", "\351\253\230\357\274\232", nullptr));
...
namespace Ui_DesignZone_3D {
    class DesignZoneWidget: public Ui_DesignZoneWidget_3D {};
} // namespace Ui
